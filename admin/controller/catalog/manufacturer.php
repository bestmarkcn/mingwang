...
class ControllerCatalogManufacturer extends Controller { 
	...
	protected function getForm() {
		...
		if (isset($this->request->post['home'])) {
			...
			$this->data['home'] = $manufacturer_info['home'];
		} else {	
			$this->data['home'] = '';
		}
		...
		if (isset($this->request->post['logo'])){
			...
			$this->data['logo'] = $manufacturer_info['logo'];
		} else {
			$this->data['logo'] = '';
		}
		if (isset($this->request->post['logo']) && file_exists(DIR_IMAGE . $this->request->post['logo'])) {
			$this->data['logo_thumb'] = $this->model_tool_image->resize($this->request->post['logo'], 100, 100);
		} elseif (!empty($manufacturer_info) && $manufacturer_info['logo'] && file_exists(DIR_IMAGE . $manufacturer_info['logo'])) {
			$this->data['logo_thumb'] = $this->model_tool_image->resize($manufacturer_info['logo'], 100, 100);
		} else {
			$this->data['logo_thumb'] = $this->model_tool_image->resize('no_image.jpg', 100, 100);
		}
