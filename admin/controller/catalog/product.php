...
class ControllerCatalogProduct extends Controller {
	...
	public function insert() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			$this->request->post['size']=serialize($this->request->post['size']);
			$this->request->post['print']=serialize($this->request->post['print']);
	...
	protected function getList() {
		...
		foreach ($results as $result) {
			...
			$this->data['products'][] = array(
				...
				'ishome'     => ($result['ishome'] ? $this->language->get('text_yes') : $this->language->get('text_no')),
	...
	protected function getForm() {
		...
		if (isset($this->request->post['download'])) {
			...
			$this->data['download'] = $product_info['download'];
		} else {
			$this->data['download'] = '';
		}		
