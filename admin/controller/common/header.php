...
class ControllerCommonHeader extends Controller {
	protected function index() {
		...
		$this->data['text_news_type'] = $this->language->get('text_news_type');
		$this->data['text_ask'] = $this->language->get('text_ask');
		$this->data['text_ask_type'] = $this->language->get('text_ask_type');
		...
		if (!$this->user->isLogged() || !isset($this->request->get['token']) || !isset($this->session->data['token']) || ($this->request->get['token'] != $this->session->data['token'])) {
			...
			$this->data['color'] = $this->url->link('catalog/color', 'token=' . $this->session->data['token'], 'SSL');
			$this->data['inquiry'] = $this->url->link('catalog/inquiry', 'token=' . $this->session->data['token'], 'SSL');
			...
			$this->data['message'] = $this->url->link('catalog/contact', 'token=' . $this->session->data['token'], 'SSL');
			$this->data['news'] = $this->url->link('news/news', 'token=' . $this->session->data['token'], 'SSL');
			$this->data['news_type'] = $this->url->link('news/news_type', 'token=' . $this->session->data['token'], 'SSL');
			$this->data['ask'] = $this->url->link('ask/ask', 'token=' . $this->session->data['token'], 'SSL');
			$this->data['ask_type'] = $this->url->link('ask/ask_type', 'token=' . $this->session->data['token'], 'SSL');
