	...
	public function index() {
        ...
        foreach($this->data['languages'] as $language){
 				if (isset($this->request->post['config_name'.$language['language_id']])) {
					$this->data['config_name'.$language['language_id']] = $this->request->post['config_name'.$language['language_id']];
				} else {
					$this->data['config_name'.$language['language_id']] = $this->config->get('config_name'.$language['language_id']);
				}
				if (isset($this->request->post['config_owner'.$language['language_id']])) {
					$this->data['config_owner'.$language['language_id']] = $this->request->post['config_owner'.$language['language_id']];
				} else {
					$this->data['config_owner'.$language['language_id']] = $this->config->get('config_owner'.$language['language_id']);
				}
		
				if (isset($this->request->post['config_address'.$language['language_id']])) {
					$this->data['config_address'.$language['language_id']] = $this->request->post['config_address'.$language['language_id']];
				} else {
					$this->data['config_address'.$language['language_id']] = $this->config->get('config_address'.$language['language_id']);
				}
		
				if (isset($this->request->post['config_email'.$language['language_id']])) {
					$this->data['config_email'.$language['language_id']] = $this->request->post['config_email'.$language['language_id']];
				} else {
					$this->data['config_email'.$language['language_id']] = $this->config->get('config_email'.$language['language_id']);
				}
		
				if (isset($this->request->post['config_telephone'.$language['language_id']])) {
					$this->data['config_telephone'.$language['language_id']] = $this->request->post['config_telephone'.$language['language_id']];
				} else {
					$this->data['config_telephone'.$language['language_id']] = $this->config->get('config_telephone'.$language['language_id']);
				}
		
				if (isset($this->request->post['config_fax'.$language['language_id']])) {
					$this->data['config_fax'.$language['language_id']] = $this->request->post['config_fax'.$language['language_id']];
				} else {
					$this->data['config_fax'.$language['language_id']] = $this->config->get('config_fax'.$language['language_id']);
				}
		
				if (isset($this->request->post['config_title'.$language['language_id']])) {
					$this->data['config_title'.$language['language_id']] = $this->request->post['config_title'.$language['language_id']];
				} else {
					$this->data['config_title'.$language['language_id']] = $this->config->get('config_title'.$language['language_id']);
				}
		
				if (isset($this->request->post['config_meta_description'.$language['language_id']])) {
					$this->data['config_meta_description'.$language['language_id']] = $this->request->post['config_meta_description'.$language['language_id']];
				} else {
					$this->data['config_meta_description'.$language['language_id']] = $this->config->get('config_meta_description'.$language['language_id']);
				}
        }
		...
		if (isset($this->request->post['config_vaccount'])) {
			$this->data['config_vaccount'] = $this->request->post['config_vaccount'];
		} else {
			$this->data['config_vaccount'] = $this->config->get('config_vaccount');
		}
		if (isset($this->request->post['config_vaccount_check'])) {
			$this->data['config_vaccount_check'] = $this->request->post['config_vaccount_check'];
		} else {
			$this->data['config_vaccount_check'] = $this->config->get('config_vaccount_check');
		}
		if (isset($this->request->post['config_total_check'])) {
			$this->data['config_total_check'] = $this->request->post['config_total_check'];
		} else {
			$this->data['config_total_check'] = $this->config->get('config_total_check');
		}
