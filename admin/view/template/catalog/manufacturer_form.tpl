      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
        <div id="tab-general">
          <table class="form">
            ...
            <tr>
              <td>Logo圖（240*120）</td>
              <td valign="top"><div class="logo"><img src="<?php echo $logo_thumb; ?>" alt="" id="logo_thumb" />
                <input type="hidden" name="logo" value="<?php echo $logo; ?>" id="logo" />
                <br /><a onclick="image_upload('logo', 'logo_thumb');"><?php echo $text_browse; ?></a>&nbsp;&nbsp;|&nbsp;&nbsp;<a onclick="$('#logo_thumb').attr('src', '<?php echo $no_image; ?>'); $('#logo').attr('value', '');"><?php echo $text_clear; ?></a></div></td>
            </tr>
              <tr>
                <td><span class="required">*</span> 內容</td>
...
<script type="text/javascript"><!--
 ...
 CKEDITOR.replace('description', {
	...
	filebrowserUploadUrl: 'index.php?route=common/filemanager/fck_upload&token=<?php echo $token; ?>',
	filebrowserImageUploadUrl: 'index.php?route=common/filemanager/fck_upload&token=<?php echo $token; ?>',
	filebrowserFlashUploadUrl: 'index.php?route=common/filemanager/fck_upload&token=<?php echo $token; ?>'
});
 //--></script> 
