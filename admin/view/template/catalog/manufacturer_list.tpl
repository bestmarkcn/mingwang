          ...
          <tbody>
              ...
              <td></td>
               ...
               <td><select name="filter_home">
                  ...
                  <?php } ?>
                  <?php if (!is_null($filter_home) && !$filter_home) { ?>
            ...
            <tr>
              ...
              <td class="left"><?php echo $manufacturer['home']; ?></td>
...
function filter() {
	...
	var filter_home = $('select[name=\'filter_home\']').attr('value');
	
	if (filter_home != '*') {
		url += '&filter_home=' + encodeURIComponent(filter_home);
	}	
