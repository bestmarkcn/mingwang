        ...
        <table class="list">
          ...
          <tbody>
            <tr class="filter">
              ...
              <td></td>
              <td align="right"><a onclick="filter(0);" class="button"><?php echo $button_filter; ?></a><a onclick="filter(1);" class="button">匯出會員</a></td>
            </tr>
            <?php if ($customers) { ?>
...
function filter(isoutput) {
  ...
  if(isoutput=='1'){
	url = 'index.php?route=sale/customer/output&token=<?php echo $token; ?>';
  }else{
