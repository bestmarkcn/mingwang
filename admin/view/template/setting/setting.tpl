...
<div id="content">
  ...
  <div class="box">
    ...
    <div class="content">
      <div id="tabs" class="htabs"><a href="#tab-general"><?php echo $tab_general; ?></a><a href="#tab-mail"><?php echo $tab_mail; ?></a><!--<a href="#tab-store"><?php echo $tab_store; ?></a><a href="#tab-local"><?php echo $tab_local; ?></a><a href="#tab-server"><?php echo $tab_server; ?></a><!--<a href="#tab-fraud"><?php echo $tab_fraud; ?></a><a  href="#tab-option"><?php echo $tab_option; ?></a><a href="#tab-image"><?php echo $tab_image; ?></a><a href="#tab-ftp"><?php echo $tab_ftp; ?></a>--></div>
          ...
          <div id="language<?php echo $language['language_id']; ?>">
           <table class="form">
            <tr>
              ...
              <td><input type="text" name="config_name<?php echo $language['language_id']; ?>" value="<?php echo ${'config_name'.$language['language_id']}; ?>" size="40" />
                 </td>
            </tr>
            <tr class="hide">
              <td><span class="required"></span> <?php echo $entry_owner; ?></td>
              <td><input type="text" name="config_owner<?php echo $language['language_id']; ?>" value="<?php echo ${'config_owner'.$language['language_id']}; ?>" size="40" />
                 </td>
            </tr>
            <tr>
              <td><span class="required"></span> <?php echo $entry_email; ?></td>
              <td><input type="text" name="config_email<?php echo $language['language_id']; ?>" value="<?php echo ${'config_email'.$language['language_id']}; ?>" size="40" />
                 </td>
            </tr>
            <tr class="hide">
              <td><span class="required"></span> <?php echo $entry_telephone; ?></td>
              <td><input type="text" name="config_telephone<?php echo $language['language_id']; ?>" value="<?php echo ${'config_telephone'.$language['language_id']}; ?>" size="40" />
                 </td>
            </tr>
            <tr class="hide">
              <td><span class="required"></span> <?php echo $entry_address; ?></td>
              <td><textarea name="config_address<?php echo $language['language_id']; ?>" cols="40" rows="5"><?php echo ${'config_address'.$language['language_id']}; ?></textarea>
                 </td>
            </tr>
            <tr class="hide">
              <td><?php echo $entry_fax; ?></td>
              <td><input type="text" name="config_fax<?php echo $language['language_id']; ?>" value="<?php echo ${'config_fax'.$language['language_id']}; ?>" /></td>
            </tr>
		    <tr>
              <td><span class="required"></span>(Keywords)關鍵字設置</td>
              <td><textarea name="config_title<?php echo $language['language_id']; ?>" cols="40" rows="5"><?php echo ${'config_title'.$language['language_id']}; ?></textarea></td>
            </tr>
            <tr>
              <td>(Description)<?php echo $entry_meta_description; ?></td>
              <td><textarea name="config_meta_description<?php echo $language['language_id']; ?>" cols="40" rows="5"><?php echo ${'config_meta_description'.$language['language_id']}; ?></textarea></td>
            </tr>
