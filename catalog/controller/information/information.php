...
class ControllerInformationInformation extends Controller {
	...
	public function printinfo() {  
		...
		if ($information_info) {
			...
			if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/information/printinfo.tpl')) {
				$this->template = $this->config->get('config_template') . '/template/information/printinfo.tpl';
			} else {
				$this->template = 'default/template/information/information.tpl';
			}
	...
	public function faq() {  
		...
		if ($information_info) {
			...
			$this->data['breadcrumbs'][] = array(
				'text'      => $information_info['title'],
				'href'      => $this->url->link('information/information/faq', 'information_id=' .  $information_id),      		
				'separator' => $this->language->get('text_separator')
			);
