			...
			$results = $this->model_catalog_product->getProducts($data);
   			    ...
   			    foreach ($results as $product_result) {
						if ($product_result['image']) {
							$image = $this->model_tool_image->resize($product_result['image'],314, 368);
						} else {
							$image = false;
						}
						$this->data['products'][] = array(
							...
							'thumb'       => $image,
							'image'       => HTTP_IMAGE.$product_result['image'],
							'name'        => $product_result['name'],
							'meta_description'=> $product_result['meta_description'],
