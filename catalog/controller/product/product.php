...
class ControllerProductProduct extends Controller {
	...
	public function index() { 
		...
		$this->data['category_info'] = $this->model_catalog_product->getCategoryByProductId($this->request->get['product_id']);
		$path = $this->model_catalog_category->getParentCategoriesByCategoryId($this->data['category_info']['category_id']);
 	    krsort($path);
		$this->request->get['path']=implode('_',$path);
		...
		if ($product_info) {
            ...
            $this->data['category_image']= $this->model_tool_image->resize($this->data['category_info']['image'],250 ,200  );
			$url = ''; 
			...
			$this->data['heading_title'] = $product_info['name_en'].$product_info['name'];
			...
			if ($product_info['image']) {
				$this->data['thumb'] = $this->model_tool_image->resize($product_info['image'], 420, 420);
			} else {
				$this->data['thumb'] = '';
			}
			...
			$this->data['tag'] = html_entity_decode($product_info['tag'], ENT_QUOTES, 'UTF-8');

 			$this->data['meta_keyword'] = html_entity_decode($product_info['meta_keyword'], ENT_QUOTES, 'UTF-8');
