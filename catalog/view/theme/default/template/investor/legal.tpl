    		...
    		<div class="container">
            	<div class="row">
					...
					<div class="col-md-9">
						...
						<h4 class="page-sub-title"><i class="fa fa-th-large"></i> 法人說明會資料</h4>
						
						<div class="margin-30 clearfix">
						<select name="jumpMenu" id="jumpMenu" onchange="MM_jumpMenu('parent',this,0)">
							<option value="index.php?route=investor/legal&filter_year=no">選擇年份</option>
							<?php foreach($year as $year_v) {?>
							<option <?php if($this->request->get['filter_year']==$year_v['year']){echo "selected ='true'" ;} ?>value="index.php?route=investor/legal&filter_year=<?php echo $year_v['year'] ?>"><?php echo $year_v['year'] ?>年</option>
							<?php } ?>
							</select>
						</div>
