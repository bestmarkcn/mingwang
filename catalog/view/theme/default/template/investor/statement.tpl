    		...
    		<div class="container">
            	<div class="row">
					...
					<div class="col-md-9">
						...
						<h4 class="page-sub-title"><i class="fa fa-th-large"></i> 財務報表</h4>
						
						<div class="margin-30 clearfix">
							<select name="jumpMenu" id="jumpMenu" onchange="MM_jumpMenu('parent',this,0)">
							<option value="index.php?route=investor/statement&filter_year=no">選擇年份</option>
							<?php foreach($year as $year_v) {?>
							<option <?php if($this->request->get['filter_year']==$year_v['year']){echo "selected ='true'" ;} ?>value="index.php?route=investor/statement&filter_year=<?php echo $year_v['year'] ?>"><?php echo $year_v['year'] ?>年</option>
							<?php } ?>
							</select>
						</div>
						<!--表格資料保留二年度-->
						...
						<div class="padding-tb20 clearfix">
							<h3>公開資訊觀測站--財務報告書</h3>
							<div>
								<a href="http://mops.twse.com.tw/mops/web/t57sb01_q1" target="_blank" class="btn btn-block btn-lg btn-investor">公開資訊觀測站</a>
							</div>
						</div>
