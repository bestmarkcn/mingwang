...
final class DBMySQL {
	...
	public function __construct($hostname, $username, $password, $database,$active_record =true) {
		...
		require_once(DIR_DATABASE.'ci_mysql/CI_constant.php');
		require_once(DIR_DATABASE.'ci_mysql/CI_function.php');
		require_once(DIR_DATABASE.'ci_mysql/database/DB_driver.php');
		if ($active_record)
		{
